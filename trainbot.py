...
model = AutoModelForCausalLM.from_pretrained(model_name, torch_dtype=torch_dtype, use_cache=False).to(device)
...
def preprocess_function(examples):
    ...
    tokenized = tokenizer(formatted_inputs, truncation=True, padding="max_length", max_length=512)
